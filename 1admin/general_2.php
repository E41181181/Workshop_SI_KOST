                  ...
                  <div class="form-group">                    
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="faskamkasur" name="check_list[]" value="Kasur">
                          <label for="faskamkasur" class="custom-control-label">Kasur</label>
                        </div> 
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="faskamlemari" name="check_list[]" value="Lemari">
                          <label for="faskamlemari" class="custom-control-label">Lemari</label>
                        </div> 
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="faskammekur" name="check_list[]" value="Meja Kursi">
                          <label for="faskammekur" class="custom-control-label">Meja Kursi</label>
                        </div> 
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="faskammanda" name="check_list[]" value="Kamar Mandi Dalam">
                        ...
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="faswifi" name="check_list[]" value="Wifi">
                          <label for="faswifi" class="custom-control-label">Wifi</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="fasdapur" name="check_list[]" value="Dapur">
                          <label for="fasdapur" class="custom-control-label">Dapur</label>
                        </div>   
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="faskaman" name="check_list[]" value="Kamar Mandi">
                          <label for="faskaman" class="custom-control-label">Kamar Mandi</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="faspar" name="check_list[]" value="Parkiran">
                          <label for="faspar" class="custom-control-label">Parkiran</label>
                        </div>   
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="fasjem" name="check_list[]" value="Jemuran">
                          <label for="fasjem" class="custom-control-label">Jemuran</label>
                        </div>   
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" id="fasrutam" name="check_list[]" value="Ruang Tamu">
