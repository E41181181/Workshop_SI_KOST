                ...
                <li class="nav-item dropdown open"><a class="nav-link link dropdown-toggle" data-toggle="dropdown-submenu" href="#" aria-expanded="true">Daftar</a>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-submenu">
                            <a class="dropdown-item" href="#">Persyaratan Pemilik</a>
                            <a class="dropdown-item" href="#">Persyaratan Penyewa</a>
                            <a class="dropdown-item" href="#">Ketentuan</a>
                            <a class="dropdown-item" href="#">--------</a>
                            <a class="dropdown-item" href="#">--------</a>
                            <a class="dropdown-item" href="#">--------</a>
                            <a class="dropdown-item" href="#">--------</a>
                            <a class="dropdown-item" href="#">--------</a>
                        </div></div><a class="dropdown-item" href="#">Pusat Bantuan</a>
                    </div>
                </li>
