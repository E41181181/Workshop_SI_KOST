                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2" data-form-type="formoid">
                        ...
                        <form method="post" action="tambah_user2.php" >
                            ...
                            <div class="form-group">
                                <input type="hidden" class="form-control" name="idkos">
                            </div>                            
                            <div class="form-group">
                                <input type="text" class="form-control" name="nama" placeholder="Nama Lengkap">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="jeskel" placeholder="Jenis Kelamin(Pria / Perempuan)">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="status" placeholder="Pelajar/Mahasiswa/Karyawan">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="alamatlengkap" placeholder="Keterangan Alamat ">
                            </div>
                            <div class="form-group">
