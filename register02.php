            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2" data-form-type="formoid">
                        ...
                        <form action="https://mobirise.com/" method="post" data-form-title="Register">
                            <input type="hidden" value="jQCgYeJ824odq/haU/Kyc/Pz2lntCtNbGH9/HVU/oytjPNL0b3iYN4PT/yBMQRLV5mKFwfvUuikKt93gPNDP5yc+GZh8vchoit6Veh4uFnR2WuL2yeHN0Vkjh7NbcXk/" data-form-email="true">
                            <div class="form-group">
                                <input type="text" class="form-control" name="name" required="" placeholder="Nama Lengkap" data-form-field="Nama">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="text" required="" placeholder="Alamat (Jalan)" data-form-field="jalan">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="text" placeholder="Alamat (Kecamatan)" data-form-field="Kecamatan">
                            </div>                            
                            <div class="form-group">
                                <input type="text" class="form-control" name="text" placeholder="Alamat (Kabupaten) " data-form-field="Kabupaten">
                            </div>
                            <div class="form-group">
                                <input type="tel" class="form-control" name="phone" placeholder="No. Telp" data-form-field="No HP">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="text" placeholder="Email" data-form-field="Email">
                            </div>
                            <div class="form-group">
                                <input type="tel" class="form-control" name="text" placeholder="Username" data-form-field="Username">
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" name="text" placeholder="Password" data-form-field="Password">
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" name="text" placeholder="Konfirmasi Password" data-form-field="Konfirmasi Password">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="text" placeholder="No. Telp" data-form-field="NIK" >
                            </div>
                            <div class="form-group">
                                    <input type="text" class="form-control" name="text" placeholder="No. Telp" data-form-field="NIK" >
                                    <select>
                            ...
                            <div class="form-group">
                                <textarea class="form-control" name="message" rows="7" placeholder="Alamat" data-form-field="Message"></textarea>
                            </div>
