...
mysqli_query($koneksi, "INSERT INTO tabel_pemilik VALUES ('$idpemilik', '$password', '$nama_lengkap', '$alamat_jalan', '$alamat_kecamatan', '$alamat_kabupaten', '$no_telp','$email','$ktp')");
